...
public class BingoHandlerTest {
    ...
    public void BM8() {
        ...
        bingoHandler.allCards[7].stampLocation("BB");
        for (int i = 2; i < 5; i++) {
            bingoHandler.allCards[7].stampLocation(""+"BINGO".charAt(i)+"B");
            bingoHandler.allCards[7].stampLocation("B"+"BINGO".charAt(i));
        }
        for (int y = 2; y < 5; y++) {
            for (int x = 2; x < 5; x++) {
    ...
    public void BM9() {
        ...
        for (int i = 0; i < 2; i++) {
            bingoHandler.allCards[0].stampLocation("B"+"BINGO".charAt(i));
            bingoHandler.allCards[0].stampLocation("B"+"BINGO".charAt(i+3));
        }
        for (int i = 0; i < 2; i++) {
            for (int y = 0; y < 2; y++) {
                for (int x = 2; x < 5; x++) {
                    bingoHandler.allCards[0].stampLocation(""+"BINGO".charAt(x)+"BINGO".charAt(y+i));
                }
            }
        }
